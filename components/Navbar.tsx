      ...
      <div className='relative md:block hidden '>
        <form onSubmit={handleSearch} className="absolute md:static top-10 left-20 bg-white">
          <input
            ...
            className='bg-primary p-3 md:text-md font-medium border-2 border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 rounded-full width-[300px] md:w-[350px] md:top-0'
          />
          <button
            onClick={handleSearch}
            className="absolute md:right-5 right-6 top-6 border-1-2 border-gray-300 pl-4 text-2xl text-gray-400"
          >
            <BiSearch />
          </button>
        </form>
